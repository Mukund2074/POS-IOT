...
const CashDrawerLayout = () => {
    ...
    const [data, setData] = useState<CashDrawerData>({
        ...
        bankTransformForm: [
            { key: 0, label: '0.50 ₹', val: 0 },
            { key: 1, label: '1 ₹', val: 0 },
            { key: 2, label: '2 ₹', val: 0 },
            { key: 3, label: '5 ₹', val: 0 },
            { key: 4, label: '10 ₹', val: 0 },
            { key: 5, label: '20 ₹', val: 0 },
            { key: 6, label: '50 ₹', val: 0 },
            { key: 7, label: '100 ₹', val: 0 },
            { key: 8, label: '200 ₹', val: 0 },
            { key: 9, label: '500 ₹', val: 0 },
            { key: 10, label: '1000 ₹', val: 0 },
        ],
        CashDifferenceForm: [
